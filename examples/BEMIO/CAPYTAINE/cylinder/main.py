...
mesh_file = os.path.join(input_data_dir, "cylinder.dat")
...
test_matrix = xr.Dataset(coords={
    "omega": np.linspace(0.08, 21.0, 525),
...
cpt.export_dataset(os.path.join(output_dir, 'cylinder_hydrodynamics.nc'), dataset)
