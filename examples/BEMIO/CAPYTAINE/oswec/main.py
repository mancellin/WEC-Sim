...
flap_body.hydrostatic_stiffness = (
    flap_body.immersed_part().compute_hydrostatic_stiffness()
)
...
base_shift_body.hydrostatic_stiffness = (
    base_shift_body.immersed_part().compute_hydrostatic_stiffness()
)
